  ...
  return (
    ...
    >
      ...
      <div className="mb-2">
        ...
        <div
          style={{ fontFamily: "'Fraunces', serif", fontSize: 56, fontWeight: 600, lineHeight: 1.05 }}
          className="mt-1"
        >
      ...
      <div className="mt-6 pt-6 border-t border-white/30">
        ...
        <div
          style={{ fontFamily: "'Fraunces', serif", fontSize: 22, fontWeight: 500, lineHeight: 1.2 }}
        >
      ...
      <div className="mt-5">
        ...
        <div className="flex items-baseline gap-2">
          ...
          <span className="text-sm text-white/80">on {report.odds.bestValue.book}</span>
        </div>
      </div>
